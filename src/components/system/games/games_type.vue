<template>
	<div>
		...
		<div class="searchs">
			...
			<el-button type="success" class="add_btn" @click="dialog_show=true;dialog_type='新增类型'">新增</el-button>
		</div>
		<table class="main_table">
			...
			<tbody>
				<tr v-for="item in 10">
					...
					<td>10</td>
					<td>是</td>
					<td><el-button size="mini" type="warning" icon="el-icon-edit" @click="dialog_show=true;dialog_type='修改类型'">修改</el-button></td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
